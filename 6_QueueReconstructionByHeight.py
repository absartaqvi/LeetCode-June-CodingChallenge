...
I am not sure if I can do it any other way besides using the built-in `sorted` method. We first sorted people in 
descending order by height. So we get this:
[[7, 0], [7, 1], [6, 1], [5, 0], [5, 2], [4, 4]]
Now when we insert by index, this means the smallest one will get bubbled to the position equal to its index.
And this approach explains I was half way there :) But, half way there is not good enough ;)
'''
